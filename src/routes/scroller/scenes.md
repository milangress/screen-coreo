...
```js
await MyAudio('ImasteDio').load('ImasteDio.mp3')
MyAudio('ImasteDio').play().setVolume(0.5)
```
...
```js
new MyWindow('kalavrita1').size(80, 80).position(20, 20).content('VideoBlock', {"src":"kalavrita1.MOV"}).open();
```
